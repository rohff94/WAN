...
include_once("./core/03-module_services/service.0.ftp.php");
include_once("./core/03-module_services/service.0.ipmi.php");
include_once("./core/03-module_services/service.0.mysql.php");
include_once("./core/03-module_services/service.0.netbios.php");
include_once("./core/03-module_services/service.0.nfs.php");
include_once("./core/03-module_services/service.0.sip.php");
include_once("./core/03-module_services/service.0.smb.php");
include_once("./core/03-module_services/service.0.smtp.php");
include_once("./core/03-module_services/service.0.snmp.php");
include_once("./core/03-module_services/service.0.ssh.php");
include_once("./core/03-module_services/service.0.ssl.php");
include_once("./core/03-module_services/service.0.vnc.php");
include_once("./core/03-module_services/service.0.vpn.php");
include_once("./core/03-module_services/service.1.all.php");
include_once("./core/04-module_web/web.0.php");
include_once("./core/04-module_web/web.url.0.php");
include_once("./core/04-module_web/web.url.param.0.php");
include_once("./core/04-module_web/web.url.param.1.ce.php");
include_once("./core/04-module_web/web.url.param.2.fi.php");
include_once("./core/04-module_web/web.url.param.3.sqli.php");
include_once("./core/04-module_web/web.url.param.4.xml.php");
include_once("./core/04-module_web/web.url.param.5.xss.php");
include_once("./core/04-module_web/web.url.param.all.php");
