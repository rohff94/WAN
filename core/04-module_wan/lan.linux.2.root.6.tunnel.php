...
class tunnel4linux extends pivot4linux{
    ...
    public function tunnel_tcp2tcp4time($stream){
        $this->ssTitre(__FUNCTION__);
        // Timeshifter
    }
    
    public function tunnel_http2tcp4cookies($stream){
        $this->ssTitre(__FUNCTION__);
        
    }
    
    public function tunnel_tcp2tcp4msn($stream){
        $this->ssTitre(__FUNCTION__);
        // MsnShell
        $this->net("http://gray-world.net/pr_msnshell.shtml");
    }
    
    public function tunnel_rtp($stream){
        $this->ssTitre(__FUNCTION__);
        // SteganRTP
    }
    public function tunnel_sip($stream){
        $this->ssTitre(__FUNCTION__);
        // stegosip.py
    }
    
    
    public function tunnel_icmp($stream) {
        $this->titre(__FUNCTION__);
        $this->tunnel_icmp_server($stream);
        $this->tunnel_icmp_client($stream);
    ...
    public function tunnel_icmp_client($stream) {
        $this->ssTitre(__FUNCTION__);
    ...
    public function tunnel_icmp4file($stream){
        $this->ssTitre(__FUNCTION__);
    ...
    public function tunnel_icmp2icmp_server($stream){
        $this->ssTitre(__FUNCTION__);
        // ###################### ICMP TUNNEL ##########################################
    ...
    public function tunnel_icmp2icmp_client($stream){
        $this->ssTitre(__FUNCTION__);
        $this->cmd($this->attacker_ip, "sudo hping3 --listen $this->user2local -I $this->eth_lan ");
        $this->pause();
    }
    
    public function tunnel_icmp2ssh($stream){
   ...
   public function tunnel_icmp2type($stream){
    ...
    public function tunnel_tcp2tcp4ssh($stream){
        // ENCAPSULATION
        // ###################### SSH TUNNEL ##########################################
    ...
    public function tunnel_tcp2tcp4covert($stream){
        /*
    ...
    public function tunnel_tcp2tcp4dns($stream){
        $this->ssTitre(__FUNCTION__);
        //dns2tcp
        // iodine
        // dnscat2
    ...
    public function tunnel_voip($stream){
        $this->ssTitre(__FUNCTION__);
        // VoVoIP
    }
    
    public function install_tunnel_udp_udp2raw($stream){
        $this->ssTitre(__FUNCTION__);
    ...
    public function tunnel_udp($stream){
        $this->ssTitre(__FUNCTION__);
        // udp2raw-tunnel
    }
    public function tunnel_arp($stream){
        $this->ssTitre(__FUNCTION__);
        
    }
    public function tunnel_tcp2udp($stream){
        $this->ssTitre(__FUNCTION__);
        // udptunnel : Tunnels TCP over UDP packets.
        // https://www.adamcouch.co.uk/tunnel-snmp-check-udp-over-ssh/
    }
    
    public function tunnel_dot($stream){
        $this->ssTitre(__FUNCTION__);
        
    }
    
    public function tunnel_http2tcp4tunneld($stream){
        $this->titre("http2tcp");
...
Usually, tunneling will actually be useful when you use the default HTTP port 80 so that the connection from tunnel client to tunnel server is not blocked by firewall.");
    ...
    public function tunnel_http2tcp4tunneld_client($stream){
    ...
    public function tunnel_icmp2tcp($stream){
    ...
    public function tunnel_http2tcp4hts_client($stream){
        $this->ssTitre("tunneld client");
