...
//$query1 = "gnome-terminal  \"$cmd1\" 2> /dev/null ";
//$query2 = "gnome-terminal  \"$cmd2\" 2> /dev/null ";
//$cmd1 = addcslashes($cmd1,'"');
//$cmd2 = addcslashes($cmd2,'"');
$query1 = "xterm -T \"$cmd1\" -e \"$cmd1_exec\" 2> /dev/null ";
$query2 = "xterm -T \"$cmd2\" -e \"$cmd2_exec\" 2> /dev/null ";
